...
import type { Task, ColumnId, Subtask, TagDef } from '../types';
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="modal__form">
              ...
              {/* Description */}
              <div className="modal__field">
                <label className="modal__label" htmlFor="task-desc">Description</label>
                <textarea
                  id="task-desc"
              ...
              <div className="modal__field">
                ...
                <AnimatePresence initial={false}>
                  {subtasks.map((s) => (
                    ...
                    >
                      <span className="modal__subtask-bullet" />
                      <span className="modal__subtask-title">{s.title}</span>
                      <motion.button
                        type="button"
